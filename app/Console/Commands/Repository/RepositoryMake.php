...
class RepositoryMake extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:repository {name} {directory} {--controller} {--service}';
     ...
     * @var string
     */
    protected $description = 'Tạo khung controller, service, repository, repositoryInterface';

    protected $files;
    protected $repo_name = '';
    protected $directory = ''; // Chỉ dùng khi tạo thư mục chứa controller và service
    ...
    {
        if ($type == 'Controller') {
            $path = $this->directory ? $this->laravel['path'] . '/Http/Controllers/' . $this->directory : $this->laravel['path'] . '/Http/Controllers';
        } else if ($type == 'Service') {
            $path = $this->directory ? $this->laravel['path'] . '/Services/' . $this->directory : $this->laravel['path'] . '/Services';
        } else {
